...
const Banner3 = ({ className }: { className?: string }) => {
    ...
    <Container className={className ? className : ""}>
      <div
        ...
        <article className='flex flex-col justify-start items-end order-1'>
          <div className='flex flex-col gap-y-4 max-w-lg z-50 lg:mr-0 mr-auto'>
            <h1 className='md:text-6xl text-4xl'>
              Earn free money with Ethical Emporium
            </h1>
            <p className='flex flex-row gap-x-0.5 items-center text-lg text-slate-500'>
              With Ethical Emporium you will get free-shipping & savings combo.
            </p>
            <button
              ...
              onClick={() =>
                router.push("https://devhasibulislam.vercel.app/")
              }>
              Discover More
            </button>
          </div>
